        ...
        if item.get("available_options", 0) < expected_num_results and api_names != ['general']:
            ...
            if ground_truth_results is not None:
                ...
                for db_item in ground_truth_results:
                    ...
                    db_item = {
                        (k.lower() if setting in ['en', 'fr', 'kr', 'de'] else value_mapping.zh2en_SLOT_MAP[k]).replace(
                            " ", "_"
            ...
            knowledge = call_api(db, api_names, constraints, lang='de', value_mapping=value_mapping, actions=actions)
            print(" > api_names:",  api_names)
            print(" > constraints:",  constraints)
            print(" > lang:",  setting)
            print(" > value_mapping:",  value_mapping)
